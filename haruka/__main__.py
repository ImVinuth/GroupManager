...
Add me to a group by clicking [here](http://t.me/GroupManager_tgbot?startgroup=true).
"""
...
def send_start(bot, update):
    ...
    keyboard += [[InlineKeyboardButton(text="🛠 Settings", callback_data="cntrl_panel_M"), 
